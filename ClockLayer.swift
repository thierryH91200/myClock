...
class ClockLayer : NSView
{
    ...
    func drawHourHand()
    {
        ...
        hourLayer.bounds = CGRect(x: 0, y: 0, width: radius * 0.04, height: CGFloat(radius * 0.70))
    ...
    func drawMinuteHand()
    {
        ...
        minuteLayer.bounds = CGRect(x: 0, y: 0, width: radius * 0.02, height: CGFloat(radius * 0.90))
    ...
    func drawSecondHand()
    {
        ...
        secondsLayer.bounds = CGRect(x: 0, y: 0, width: radius * 0.01, height: CGFloat(radius * 0.90))
